...
const GITHUB_OAUTH_URL = `https://github.com/login/oauth/authorize?client_id=${GITHUB_CLIENT_ID}&scope=repo,read:user&redirect_uri=${encodeURIComponent(window.location.origin + '/auth/callback')}`;
  ...
  return (
    <AnimatedSection style={{
      ...
      <p style={{
        ...
        Join thousands of developers, founders, and teams who've stopped guessing and started seeing.
      </p>
      <motion.div
      ...
      >
        ...
        <a href={GITHUB_OAUTH_URL} className="lp-btn-secondary" style={{ textDecoration: 'none' }}>
